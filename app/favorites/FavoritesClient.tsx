          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8">
            {favorites.map((product, index) => (
              ...
              >
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-3 md:p-6 text-center bg-surface z-20 border-t border-black/5 relative">
                  <h3 className="text-base md:text-2xl font-black text-foreground mb-0.5 md:mb-1">{product.name}</h3>
                  <p className="text-accent text-[9px] md:text-[10px] tracking-[0.2em] uppercase mb-2 md:mb-4">{product.engName || 'TIMEPIECE / CURATED'}</p>
