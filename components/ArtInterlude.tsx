export default function ArtInterlude() {
  return (
    <section className="relative overflow-hidden bg-brand text-surface py-24 md:py-36" dir="rtl" aria-label="فلسفة أثر">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-[.8fr_1.6fr_.6fr] items-center gap-10">
        ...
        <div className="text-center md:text-right md:pr-10">
          ...
          <h2 className="font-display text-4xl md:text-7xl leading-tight mt-6 mb-6">كل دقيقة<br /><span className="text-accent">تترك أثرًا</span></h2>
