...
import { X, ShoppingBag, CreditCard, Minus, Plus, Heart } from 'lucide-react';
                ...
                >
                  <div className="relative w-full h-[58%] bg-[radial-gradient(circle_at_50%_42%,#ffffff,#d9d5ca)] p-4 flex items-center justify-center">
                    ...
                    {product.image ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center text-accent/30 text-4xl font-mono tracking-widest">ORVÉN</div>
                    )}
                  </div>
